...
public class TSVD4JMojo extends AbstractTSVD4JMojo {
    ...
    private final static String VERSION = "0.1-optimized-SNAPSHOT";
    ...
    protected Xpp3Dom applyConfig(Xpp3Dom configuration)  {
        ...
        String argLineToSet = "-javaagent:" + getPathToTSVD4JJar(localRepo)
            + " -Dtsvd4j.firstIterationOnly=true";
    ...
    private String getPathToTSVD4JJar(String localRepo) {
        String result = Paths.get(localRepo, "edu", "utexas", "ece", "optimized", "tsvd4j-first-iteration-core", VERSION, "tsvd4j-first-iteration-core-" + VERSION + ".jar").toString();
